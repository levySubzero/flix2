...
const MovieCard: React.FC<MovieCardProps> = ({ id, title, description, thumbnailUrl, videoUrl, duration, genre }) => {
  ...
  return (
    <div className="group bg-zinc-900 col-span relative h-[12vw]">
      <img onClick={redirectToWatch} src={thumbnailUrl} alt="Movie" draggable={false} className="
        cursor-pointer
        object-cover
        transition
        duration
